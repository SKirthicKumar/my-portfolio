          ...
          v.jsx(Th, {
            children: v.jsxs(sk, {
              children: [
                ...
                v.jsx("h3", { children: "I'm Kirthic Kumar" }),
                v.jsx("h6", {
                  children:
                    "A PHP developer who builds reliable, scalable web applications with clean code and practical solutions.",
                }),
              ],
            }),
          }),
...
`,
  ...
  _h = S.lazy(() => K(() => import("./SocialIcons-DdUsFf1Y.js?v=2"), [])),
  ck = S.lazy(() => K(() => import("./LogoComponent-COFNQSqI.js?v=2"), [])),
  fk = R(W.div)`
  &::selection {
    color: white;
...
`,
            ...
            v.jsxs(dk, {
              children: [
                ...
                a
                  ? v.jsx(bh, {
                      click: +e,
                      href: "mailto:kirthickumar689@gmail.com",
                      onClick: () =>
                        window.open(
                          "mailto:kirthickumar689@gmail.com",
                          "_blank",
                        ),
                      children: v.jsx(W.h3, {
                        initial: {
  ...
  Ck = S.lazy(() => K(() => import("./SocialIcons-DdUsFf1Y.js?v=2"), [])),
  Pk = S.lazy(() => K(() => import("./PowerButton-7EvZcJPM.js"), [])),
  Ek = S.lazy(() => K(() => import("./LogoComponent-COFNQSqI.js?v=2"), [])),
          ...
          bk,
          {
            ...
            children: [
              ...
              v.jsxs(Lk, {
                ...
                children: [
                  "I'm Kirthic Kumar, a PHP developer who builds reliable web applications and practical backend solutions.",
                  v.jsx("br", {}),
                  v.jsx("br", {}),
                  "I work with PHP, Laravel, MySQL, REST APIs, JavaScript, HTML, and CSS to turn ideas into clean, maintainable products.",
                  v.jsx("br", {}),
                  v.jsx("br", {}),
                  "When I'm not coding, I'm learning better development practices, improving database design, and exploring tools that make web applications faster and easier to maintain.",
                  v.jsx("br", {}),
                  v.jsx("br", {}),
                  "Looking to build a PHP application or website? Let's talk.",
                ],
              }),
...
`,
  ...
  Wk = S.lazy(() => K(() => import("./SocialIcons-DdUsFf1Y.js?v=2"), [])),
  Hk = S.lazy(() => K(() => import("./PowerButton-7EvZcJPM.js"), [])),
  Gk = S.lazy(() => K(() => import("./LogoComponent-COFNQSqI.js?v=2"), [])),
...
`,
  ...
  qk = [
    ...
    },
    {
      ...
      name: "S2S Taxi",
      description:
        "A taxi booking and management web application built for reliable daily operations and customer bookings.",
      tags: ["PHP", "Laravel", "MySQL", "REST APIs"],
      demo: "#",
      github: "#",
      image: "/assets/profile-img-LyKEUko9.png",
    },
    {
      id: 20,
      name: "PK Drop Taxi",
      description:
        "A live taxi service platform supporting booking workflows, backend operations, and application maintenance.",
    ...
    },
    {
      ...
      name: "RoboNexus",
      description:
        "A web project focused on delivering a structured digital experience with a maintainable PHP backend.",
    ...
    {
      id: 22,
      name: "Sivankangai EB Project",
      description:
        "A utility-focused web application for organizing and managing electricity service information.",
      tags: ["PHP", "Laravel", "MySQL", "JavaScript"],
      demo: "#",
      github: "#",
      image: "/assets/profile-img-LyKEUko9.png",
    ...
    {
      id: 23,
      name: "HealthIntake Forms",
      description:
        "A form-based application for collecting, organizing, and managing health intake information securely.",
      tags: ["PHP", "Laravel", "MySQL", "Forms"],
      demo: "#",
      github: "#",
      image: "/assets/profile-img-LyKEUko9.png",
    },
...
`,
  ...
  u4 = S.lazy(() => K(() => import("./SocialIcons-DdUsFf1Y.js?v=2"), [])),
  c4 = S.lazy(() => K(() => import("./PowerButton-7EvZcJPM.js"), [])),
  f4 = S.lazy(() => K(() => import("./LogoComponent-COFNQSqI.js?v=2"), [])),
...
`,
  ...
  y4 = S.lazy(() => K(() => import("./SocialIcons-DdUsFf1Y.js?v=2"), [])),
  v4 = S.lazy(() => K(() => import("./PowerButton-7EvZcJPM.js"), [])),
  w4 = S.lazy(() => K(() => import("./LogoComponent-COFNQSqI.js?v=2"), [])),
...
`,
            ...
            children: [
              ...
              v.jsxs(As, {
                children: [
                  ...
                  v.jsx(qn, {
                    children:
                      "Building reliable web applications with PHP, Laravel, databases, and clean backend architecture.",
                  }),
                  v.jsxs(qn, {
                    children: [
                    ...
                    children: [
                      ...
                      v.jsxs("ul", {
                        children: [
                          ...
                          v.jsx("li", { children: "Git, GitHub, REST APIs" }),
                          v.jsx("li", {
                            children: "Laravel, WordPress, Bootstrap",
                          }),
                        ],
                      }),
                    ],
              ...
              v.jsxs(As, {
                children: [
                  v.jsxs(Dh, {
                      children: [v.jsx(nk, { width: 40, height: 40 }), " Web Development"],
                  }),
                  v.jsx(qn, {
                    children:
                      "Creating responsive, user-friendly websites and APIs that connect clean interfaces to dependable backend systems.",
                  }),
                  v.jsxs(qn, {
                    children: [
                      ...
                      v.jsx("p", {
                        children:
                          "PHP Web Applications, Laravel APIs, Database Design, Authentication",
                      }),
                    ],
                  }),
                  v.jsxs(qn, {
                    children: [
                      ...
                      v.jsx("p", {
                        children:
                          "PHPStorm, VS Code, Postman, GitHub",
                      }),
                    ],
                  }),
                ],
  ...
  P4 = [
    {
      id: 1,
      company: "Alphavire Tech Pvt Ltd",
      role: "PHP Developer (Internship)",
      period: "Aug 2023 - Oct 2023",
      location: "India",
      type: "Internship",
      description:
        "Learned HTML, CSS, JavaScript, MySQL, PHP, and Laravel during the internship. Built and maintained web applications while improving performance and keeping up with current development practices.",
      keyPoints: [
        ...
        "Stayed updated with current web development trends",
      ],
      skills: [
        "PHP",
        "Laravel",
    ...
    },
    {
      ...
      role: "PHP Developer (CodeIgniter | Laravel)",
      period: "Apr 2025 - Feb 2026",
      location: "India",
      type: "Full-time",
      description:
        "Contributed to the development, deployment, and maintenance of multiple live web applications across high-impact projects, including Wizz Bazaar, Nox Bricks, S2S Taxi, and PK Drop Taxi.",
      keyPoints: [
        "Developed core backend functionality using PHP and related technologies",
        "Conducted end-to-end testing, resolved bugs, and maintained code quality",
        "Managed deployment from staging to production",
        "Collaborated with cross-functional teams to align development with business requirements",
        "Maintained live applications for functionality, scalability, and security",
      ],
      skills: [
        "PHP",
        "CodeIgniter",
  ...
  E4 = S.lazy(() => K(() => import("./SocialIcons-DdUsFf1Y.js?v=2"), [])),
  T4 = S.lazy(() => K(() => import("./PowerButton-7EvZcJPM.js"), [])),
  _4 = S.lazy(() => K(() => import("./LogoComponent-COFNQSqI.js?v=2"), [])),
